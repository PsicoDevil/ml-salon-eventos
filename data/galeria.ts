 ...
 * - galleryItems: selección curada de 7 piezas para el preview de la
...
export const galleryCollection: GalleryItem[] = [
  // ── Bodas ──────────────────────────────────────────────────────────
  { src: "/images/bodas/boda3.png", alt: "Boda celebrada en el salón", category: "bodas", width: 1153, height: 1364 },
  ...
  { src: "/images/quince/cartel-milena.png", alt: "Cartel personalizado de la fiesta de 15", category: "quince", width: 2048, height: 1366 },

  // ── Egresados ──────────────────────────────────────────────────────
  { src: "/images/egresados/egresados.jpg", alt: "Fiesta de egresados en el salón", category: "egresados", width: 1536, height: 2048 },
  { src: "/images/egresados/gentecomiendo.jpg", alt: "Invitados disfrutando de la cena", category: "egresados", width: 960, height: 720 },
  { src: "/images/cumpleanos/fiestajovenes.jpg", alt: "Pista de baile en la fiesta de egresados", category: "egresados", width: 1280, height: 720 },
  { src: "/images/egresados/carteleriaegresados.jpg", alt: "Cartelería de la fiesta de egresados", category: "egresados", width: 2048, height: 1536 },
  { src: "/images/salon/salondec.png", alt: "Interior del salón decorado para la fiesta", category: "egresados", width: 1448, height: 1086 },
  { src: "/images/salon/decosalon4.jpg", alt: "Salón ambientado para la fiesta de egresados", category: "egresados", width: 2048, height: 1536 },
  // ── Cumpleaños ─────────────────────────────────────────────────────
  ...
  { src: "/images/corporativos/corpo.png", alt: "Evento corporativo en el salón", category: "corporativos", width: 1536, height: 1024 },
  ...
  { src: "/images/celebraciones/comida-mesa.jpg", alt: "Buffet de la recepción del evento", category: "corporativos", width: 1280, height: 853 },
  { src: "/images/celebraciones/entradacomida.jpg", alt: "Entrada de los platos a la mesa", category: "corporativos", width: 2048, height: 1536 },
  // ── Salón ──────────────────────────────────────────────────────────
  ...
  { src: "/images/salon/decoracion.png", alt: "Detalles de la decoración del salón", category: "salon", width: 1024, height: 1536 },
  ...
  { src: "/images/aire-libre/piletanoche.png", alt: "La pileta y el salón iluminados al atardecer", category: "aire-libre", width: 1448, height: 1086 },
];

/**
 * Preview de la Home: selección curada de 7 piezas (una por categoría,
